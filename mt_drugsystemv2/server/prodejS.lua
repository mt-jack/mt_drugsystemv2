    ...
    RegisterCommand('dealer', function(source, args, rawcommand)
        ...
        for k, v in pairs(Config.drugs) do
            ...
            if drugToSell.count ~= 0 then
                ...
                TriggerClientEvent('mt_drugsystem:findClient', source, drugToSell)
                break
            end
...
RegisterServerEvent('mt_drugsystem:pay')
AddEventHandler('mt_drugsystem:pay', function(drugToSell)
    xPlayer = ESX.GetPlayerFromId(source)
